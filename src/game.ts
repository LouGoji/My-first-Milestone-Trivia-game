...
let getNewQuestion = () => {
    ...
    questionCounter++
    progressText ? progressText.innerHTML = `Question ${questionCounter} of ${MAX_QUESTIONS}`: null;
    progressBarFull ? (progressBarFull as HTMLElement).style.width = '${(questionCounter/MAX_QUESTION) * 100}%': null;
    console.log
...
function incrementScore(SCORE_POINTS: number) {
